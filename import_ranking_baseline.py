...
RANKING_DATA = [
    ...
    ("HERNAN",    "GYALOG",       "Tercera", 185),
    ("MAXI",      "LICANDRO",     "Tercera", 175),
    ("NICO",      "SILVERA",      "Tercera", 175),
    ("RODRI",     "FRANCO",       "Tercera", 175),
    ...
    # === CUARTA ===
    ("QUIQUE",      "FRAGA",        "Cuarta", 500),
    ("DEMETRIO",    "FERREIRA",     "Cuarta", 500),
    ("MAXI",        "LICANDRO",     "Cuarta", 175),
    ...
    ("NICO",        "MARTINEZ",     "Cuarta", 150),
    ("LUCAS",       "LABANDERA",    "Cuarta", 150),
    ("FACU",        "SPIRA",        "Cuarta", 150),
    ("HERNAN",      "GYALOG",       "Cuarta", 150),
